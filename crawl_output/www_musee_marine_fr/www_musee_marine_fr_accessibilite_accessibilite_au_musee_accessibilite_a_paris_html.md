# https://www.musee-marine.fr/accessibilite/accessibilite-au-musee/accessibilite-a-paris.html
...
Rechercher
 1. Accueil 
 2. • Accessibilité 
 3. • Accessibilité au musée 
 4. • Accessibilité à Paris 
...
### Visiteurs en fauteuil ou à mobilité réduite

### Visiteurs malentendants

### Visiteurs Sourds signants

### Visiteurs malvoyants ou non-voyants

### Visiteurs en situation de handicap mental

### Visiteurs avec troubles du spectre autistique ou hypersensibilité
### Réserver votre visite
Réserver votre billet ou votre visite en ligne*, à tout moment, ou par téléphone (du lundi au vendredi de 10h à 18h et le samedi de 10h à 17h). 
ACCEO, un dispositif de réservation dédié aux personnes malentendantes et Sourdes est disponible. 
*Billetterie non conforme aux normes d'accessibilité
 * 01 53 65 69 48 
 * Réserver en ligne 
 * Réserver via ACCEO 

## En savoir plus sur l'accessibilité
Consultez le registre public d'accessibilité pour préparer votre visite du musée à Paris
Télécharger le document En savoir plus sur l'accessibilité (PDF - 639 Ko) 
