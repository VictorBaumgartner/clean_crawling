# https://www.musee-marine.fr/enseignants/dossiers-pedagogiques/la-sculpture-navale-du-xviie-au-xixe-siecle.html
...
Rechercher
 ...
 4. • La sculpture navale du XVIIᵉ au XIXᵉ siècle 

## Partager sur
 * 

# La sculpture navale du XVIIᵉ au XIXᵉ siècle
Dossier pédagogique 
La sculpture navale est un art à part entière grâce auquel le pouvoir politique qu’il soit royal ou impérial doit, dans un premier temps, être valorisé. Le dossier présente l’évolution des thèmes et des styles décoratifs, les grands noms de la sculpture navale, les métiers d’art, les figures de proues et leur figuration, la rationalisation des décorations jusqu’à leur disparition avec celle de la marine militaire à voile. 
## Ouvertures disciplinaires
 * Les activités peuvent être mises en œuvre pour travailler une ou plusieurs compétences, accompagner un projet pluridisciplinaire ou entrer dans un thème.
 * Liens entre les disciplines d’histoire-géographie, des arts appliqués, de lettres et d’histoire des arts, de technologie pour différents niveaux de classe.

## Mobilisation de compétences spécifiques en histoire des arts et mise en œuvre des piliers de l’EAC
### Quelques compétences associées à l’histoire des arts
 ...
 * Associer une œuvre à une époque et une civilisation en fonction d’éléments de langage artistique, amorcer, à l’aide de ces éléments, un discours critique.
...
### Mise en œuvre des piliers de l’EAC
 * Rencontre directe et sensible des œuvres,
 * Sensibilisation à une pratique artistique
 * Acquisition de connaissances

### Quelques liens avec les programmes d’histoire, de lettres et d’histoire des arts
Cycle 3
 * Le temps des rois, Louis XIV, le roi Soleil à Versailles (Histoire | CM1)
 * Le monstre, aux limites de l’humain. Récit d’aventures (Lettres | 6e)

Cycle 4
 * « Le voyage et l’aventure : pourquoi aller vers l’inconnu ? » (Lettres | 5e)
 * État, société et modes de vie (XIIIe-XVIIIe siècle )
 * Évolution des sciences et techniques... (HDA| 4e)
 * Culture et création artistique, science, technologie et société (Arts plastiques | cycle 4)

Lycée :
 * « Se dire, s’affirmer, s’émanciper » (Lettres | CAP)
 * « Dire, écrire, lire le métier » (Lettres | Bac Pro)
 * L’État à l’époque moderne (Histoire| Seconde générale et technologique)
 * Métiers, compagnons, compagnonnage et chef-d’œuvre au XIXe siècle (Histoire| Seconde professionnelle)
 * Thème : Les matières, les techniques et les formes : production et reproduction des œuvres uniques ou multiples (HDA | Enseignement de spécialité | 1ère)

 * zoomin Agrandir l'image : DP-SCULPTURE-2-c_-MnM--L.-S.jpg Sirène, cariatide de poupe, XVIIIe siècle. Sculpteur : Antoine Gibert (1716-1789) © Musée national de la Marine / L.S. Jaulmes 

## Le dossier pédagogique 
Le dossier pédagogique est composé de fiches à associer entre elles, selon les approches et les niveaux d’enseignement.
## Repères 
Présente une synthèse du thème, de courtes mises aux points (biographies, institutions…), un renvoi vers les documents originaux ainsi qu’une bibliographie et une sitographie. 
Télécharger le document Repères (PDF - 17 Mo) 
## Documents
Propose une sélection littéraire et documentaire sur un thème. Des numérisations de documents originaux, dont certains sont conservés par le musée au centre de Ressources à Dugny, à destination étudiants, élèves ou enseignants pour des usages pédagogiques.
Télécharger le document Documents (PDF - 28 Mo) 
### Activités
Pour les élèves, à faire en individuel ou en groupe. Chacune comporte des contextualisations et questionnements sur des œuvres ou des archives du musée, apportant un complément essentiel à la compréhension du thème.
Elles permettent de mettre en œuvre des compétences disciplinaires ou transversales.
Les niveaux de classes ne sont pas mentionnés sur le document afin de permettre une exploitation pédagogique personnalisée.
## Activités Primaire (HDA)
Dans l’atelier de sculpture et de peinture de l’arsenal.
Télécharger le document Activités Primaire (HDA) (PDF - 19 Mo) 
## Activités Secondaire (HDA)
Évolution des décors à la gloire du roi.
Télécharger le document Activités Secondaire (HDA) (PDF - 18 Mo) 
## Parcours
Comprend un plan du musée avec la localisation d’œuvres en lien avec le thème, un visuel des œuvres sélectionnées et les points remarquables à y observer. Il est spécifique à chaque site pour permettre une visite de l’enseignant avec sa classe en autonomie.
( à télécharger prochainement )
## Dossier pédagogique
Ensemble des dossiers pédagogiques
