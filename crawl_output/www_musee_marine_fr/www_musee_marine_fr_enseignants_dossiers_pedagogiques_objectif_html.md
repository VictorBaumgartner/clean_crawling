# https://www.musee-marine.fr/enseignants/dossiers-pedagogiques/objectif.html
...
DOSSIER PÉDAGOGIQUE
Il propose un vue d’ensemble de l’exposition : le plan général, la thématique des salles ainsi que des pistes d’observations actives pour les élèves pendant leur visite. 
## Parcours pour une visite en autonomie avec sa classe
Principalement dédié aux classes à option Cinéma et Audiovisuel et à l’enseignement de spécialité CAV dont il met en évidence les liens, le dossier rappelle des points des programmes de Français et Histoire des Arts de classes de collège et de CAP qui pourraient trouver une résonnance avec la visite de l’exposition.
Il propose un vue d’ensemble de l’exposition : le plan général, la thématique des salles ainsi que des pistes d’observations actives pour les élèves pendant leur visite.
## Mise en œuvre des piliers de l’EAC
 * Rencontre directe et sensible des œuvres,
 * Sensibilisation à une pratique artistique : atelier « affiche ton son »
 * Acquisition de connaissances

## Parcours
Télécharger le document Parcours (PDF - 3 Mo) 
## Dossier pédagogique
