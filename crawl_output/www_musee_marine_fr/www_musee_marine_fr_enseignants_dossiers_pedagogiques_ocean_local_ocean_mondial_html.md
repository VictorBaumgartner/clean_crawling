# https://www.musee-marine.fr/enseignants/dossiers-pedagogiques/ocean-local-ocean-mondial.html
...
Rechercher
 ...
 4. • Océan local, océan mondial 

## Partager sur
 * 

# Océan local, océan mondial
Dossier pédagogique 
Pour permettre une vue d’ensemble, le dossier propose des repères sur le droit de la mer, les aires marines protégées, le patrimoine marin et sous-marin mondial, les objectifs et développement durable (ODD) de l’ONU d’ici 2030, la décennie des sciences océaniques, les engagements locaux dans un espace mondialisé pour la préservation des mers et des océans. 
De courtes présentations sont aussi proposées sur les instances internationales créées pour la gestion géopolitique, scientifique et sociale des océans.
Ce dossier sert d’introduction aux thèmes à venir : le transport maritime, la pêche et les ressources halieutiques, les énergies et la mer.
## Un thème transversal
Ce dossier pose des jalons pour découvrir, comprendre et réfléchir sur les enjeux autour des océans grâce à la présentation d’acteurs de la protection et de la gestion des océans au niveau international, national et local, et à la description des grandes lignes tracées avec les ODD qui prennent en compte les inégalités de développement.
Les liens entre les disciplines comme la géographie, l’EMC, la SVT et les lettres peuvent favoriser des projets pluridisciplinaires.
## Quelques liens avec les programmes de géographie, EMC, SVT et lettres
### Cycle 3
 * Habiter les littoraux (géographie | 6e)
 * La planète Terre. Les êtres vivants dans leur environnement. Identifier des enjeux liés à l’environnement (SVT | cycle 3)

### Cycle 4
 * L’environnement, du local au planétaire (géographie | 5e)
 * Des espaces transformés par la mondialisation : Mers et océans, un monde maritimisé (géographie | 4e)
 * Culture de l’engagement. Penser l’engagement comme acte individuel et collectif (EMC | cycle 4)
 * Agir sur le monde : informer, s’informer, déformer. Les enjeux environnementaux (lettres | 4e)
 * Responsabilité humaine en matière de santé et d’environnement (SVT | 3e)
 * Agir dans la cité : individu et pouvoir (engagement) (lettres | 3e)

### Lycée
 * Sociétés et environnement : des équilibres fragiles (géographie | seconde GT)
 * Informer, s’informer (lettres | seconde professionnelle)
 * Repenser et faire vivre la démocratie : La responsabilité environnementale (EMC | Tale)
 * Affirmer sa puissance à partir des mers et des océans | Rivalités et coopérations dans le partage, l'exploitation et la préservation des ressources des mers et des océans (HGGSP | 1ère)
 * L’environnement, entre exploitation et protection : un enjeu planétaire (HGGSP | Tale)

 * zoomin Agrandir l'image : DP-OCEAN-1-AdobeStock321531350.jpg Sous l’océan © stock.adobe.com 
...
## Repères
présente une synthèse du thème, de courtes mises au point spécifiques (institutions…) ainsi qu’une bibliographie et une sitographie.
Télécharger le document Repères (PDF - 12 Mo) 
## Dossier pédagogique
