# https://www.nimes.fr/annuaire?tx_solr%5Bpage%5D=2&tx_solr%5Bview%5D=LIST
...
Par thématique (multiple doktype)
 * ADMINISTRATIF (198)
 * AMENAGEMENT (446)
 * CULTURE (37)
 * ENSEIGNEMENT, ENFANCE ET JEUNESSE (137)
 * MAIRIE ET HOTEL COMMUNAUTAIRE (91)
 * PROPRETE ET DECHETS (200)
 * SANTE (2)
 * SECURITE ET PREVENTION DES RISQUES (10)
 * SERVICES AU PUBLIC (28)
 * SPORTS ET LOISIRS (300)
 * TOURISME ET ANIMATION (20)
 * TRANSPORTS (23)

Par sous type d'annuaire
Choisir une option AIRES DE JEUX ET DE LOISIRS BIBLIOTHEQUE DECHETS EMPLACEMENTS RESERVES ESPACE CULTUREL HANDICAP INSTALLATIONS SPORTIVES JEUNESSE MAIRIE ET HOTEL COMMUNAUTAIRE MARCHE MUSEE NUMERIQUE PARKING PETITE ENFANCE PREMIER DEGRE PROFESSIONNEL PROPRETE SALLE DE SPECTACLE SECOND DEGRE SENIORS SERVICES AU PUBLIC SERVICES DE SECURITE SITE REMARQUABLE SOINS SOLIDARITE SPORTS COLLECTIFS SPORTS INDIVIDUELS SUPERIEUR TOURISME TRANSPORTS
Affichage des résultats de 11 à 20 sur 1492. 
 * Mode liste
 * Mode carte

 * ### Office des Séniors 
 * MAIRIE ET HOTEL COMMUNAUTAIRE
 * SENIORS
 * 14 Rue des Chassaintes 30900 Nîmes
 * ### Accueil Canicule (Foyer Enclos Rey) 
 * MAIRIE ET HOTEL COMMUNAUTAIRE
 * SENIORS
 * 42 Rue Enclos Rey 30000 Nîmes
 * ### Accueil Canicule (CAM - Mas de Mingue) 
 * MAIRIE ET HOTEL COMMUNAUTAIRE
 * SENIORS
 * 251 Avenue Monseigneur Claverie 30000 Nîmes
 * ### Accueil Canicule (Les Grillons - Mas de Mingue) 
 * MAIRIE ET HOTEL COMMUNAUTAIRE
 * SENIORS
 * 251 Avenue Monseigneur Claverie 30000 Nîmes
 * ### Stade des Antonins 
 ...
 * SPORTS COLLECTIFS
 * 30000 Nîmes
 * ### DDASS (Direction departementale des affaires Sanitaires et Sociales) - Nîmes 
 * ADMINISTRATIF
 * SERVICES AU PUBLIC
 * 6 Rue du Mail 30900 Nîmes
 * ### Bureau de Vote 417 - Paul Langevin Maternelle 
 * ADMINISTRATIF
 * SERVICES AU PUBLIC
 * 3 Rue Edgar Poe 30900 Nîmes
 * ### Service Education (Enseignement) - Nîmes 
 * ADMINISTRATIF
 * SERVICES AU PUBLIC
 * 152 Avenue Robert Bompard 30000 Nîmes
 * ### Centre de Vaccinations Internationales - Nîmes 
 * ADMINISTRATIF
 * SERVICES AU PUBLIC
 * 65B Rue de la République 30900 Nîmes
 * ### Service Jeunesse - Nîmes 
 * ADMINISTRATIF
 * SERVICES AU PUBLIC
 * 9A Rue Grétry 30900 Nîmes
