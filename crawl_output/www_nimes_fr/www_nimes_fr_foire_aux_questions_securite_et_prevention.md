# https://www.nimes.fr/foire-aux-questions/securite-et-prevention
...
Cette foire aux questions pourra répondre à vos interrogations concernant la sécurité et la prévention à Nîmes.
Accès rapides
 * Sécurité et prévention 

## Sécurité et prévention 
 * Télécharger le guide pratique "Stop aux violences faites aux femmes" (PDF, 652 ko) 

 * ### Quels sont les numéros d'urgence à Nîmes ? 
Vous pouvez contacter la police en composant le 17 ou les pompiers au 18. Le 114 est un service par SMS pour les situations d’urgence.
 * ### Quels dispositifs existent pour la prévention des violences faites aux femmes ? 
La ville propose le dispositif Angela pour les femmes en danger, ainsi que des structures d’hébergement et d’accompagnement.
 * ### Quels services de soutien sont offerts aux victimes de violences ? 
Des services d’aide juridique, d’hébergement et de soutien psychologique sont disponibles pour les victimes de violences.
 * ### Comment contacter la police municipale ? 
Vous pouvez joindre la police municipale au 04 66 76 70 99 ou en vous rendant aux différents postes.
 * ### Comment puis-je savoir si mon logement est en zone à risque ? 
Consultez le Document d'Information Communal sur les Risques Majeurs (DICRIM) disponible sur le site de la Ville de Nîmes.
 * ### Comment signaler un logement insalubre ? 
Le Service prévention des risques de la Ville de Nîmes est chargé d’instruire les plaintes concernant les logements loués présentant un ou plusieurs critères d’indécence ou d’insalubrité.Plus d'informations ici.
 * ### J’ai réservé les repas, est ce que je dois payer pour valider ma réservation ? 
Oui le paiement est obligatoire pour valider la réservation.
