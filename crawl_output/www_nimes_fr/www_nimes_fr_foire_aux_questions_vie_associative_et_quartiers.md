# https://www.nimes.fr/foire-aux-questions/vie-associative-et-quartiers
 ...
 * Trouver une adresse, un contact
 ...
 3. Vie associative et quartiers

# Vie associative et quartiers 
Cette foire aux questions pourra répondre à vos interrogations concernant les associations nîmoises et les conseils de quartier.
Accès rapides
 * Vie associative et quartiers 

## Vie associative et quartiers 
 * ### Qu'est-ce que la Maison des Associations de Nîmes ? 
C’est un espace dédié aux associations, offrant des services tels que la location de salles, l'accès à du matériel et du soutien administratif.
 * ### Quels services sont disponibles pour les associations ? 
Mise à disposition de salles de réunion, pôle multimédia, reprographie, prêt de matériel numérique, et un guichet unique pour centraliser les demandes.
 * ### Comment demander une subvention auprès de la Ville ? 
Toute demande de subvention ou avantage en nature s'effectue exclusivement de façon dématérialisée : cliquez ici.
 * ### Qui compose les conseils de quartiers ? 
Chaque conseil inclut des élus, des présidents de comités de quartier, des représentants associatifs et des habitants locaux.
 * ### Quel est le budget annuel alloué à chaque conseil de quartier ? 
Chaque conseil dispose de 100 000 € par an pour financer des projets locaux.
 * ### Comment trouver une association à Nîmes ? 
Vous pouvez retrouver sur cette page la liste des associations présentes au Forum des associations 2004 à Nîmes.
