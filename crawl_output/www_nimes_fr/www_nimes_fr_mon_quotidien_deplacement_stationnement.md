# https://www.nimes.fr/mon-quotidien/deplacement-stationnement/#main-menu
 ...
 * Trouver une adresse, un contact
 ...
 1. Nîmes
 2. Mon quotidien
 3. Déplacement, stationnement

# Déplacement, stationnement 
Demander une autorisation de stationnement, se déplacer en bus ou à vélo : retrouver toutes les informations et démarches pratiques sur cette page.
Accès rapides
## La zone à faibles émissions mobilité (ZFE-m) 
Une zone à faibles émissions (ZFE) est un périmètre dans lequel la circulation des véhicules les plus polluants est limitée ou interdite. Découvrez ce qu'il en est pour la commune de Nîmes
Consulter la rubrique
## Se déplacer 
 * À pied, à vélo
 * En transport en commun
 * En voiture, en deux roues
 * En train, en avion

Consulter la rubrique
## Stationner 
Le centre-ville de Nîmes compte 5100 places de stationnement payant réglementées sur voirie. Ces places sont réparties en 2 zones : zone rouge et zone verte.
 * Bien stationner à Nîmes
