# https://www.nimes.fr/mon-quotidien/ecoles-et-centres-de-loisirs/les-accueils-periscolaires-de-nimes-alae
 ...
 * Trouver une adresse, un contact
 ...
 1. Nîmes
 2. Mon quotidien
 3. Écoles et accueils de loisirs
 4. Les accueils périscolaires de Nîmes (ALAE)

# Les accueils périscolaires de Nîmes (ALAE) 
L'ALAÉ (Accueil de Loisirs Associé à l'École) est un service facultatif qui propose des activités éducatives et de loisirs pour les enfants durant les temps périscolaires.

Accès rapides
 * Qu'est-ce qu'un ALAÉ ? 
 * Devenir animateur de temps périscolaires 

## Qu'est-ce qu'un ALAÉ ? 
L’ALAé est un accueil facultatif qui offre à votre enfant des activités éducatives et de loisirs durant les temps périscolaires.
L’ALAé vous propose un mode d’accueil facultatif qui permet de concilier :
 * vos contraintes horaires 
 * les rythmes et les besoins de votre enfant

L'ALAÉ couvre :
 * le matin : 7h30 à 8h30
 * le temps méridien avec ou sans repas: 11h30 à 13h30 (le temps du repas est soumis à une tarification spécifique)à partir de 16h30 (fin de la classe) jusqu’à 18h30

Le référent ALAÉ de l'école : Il est là pour répondre aux questions des parents qui sont invités à entrer en contact avec lui pour connaître les précisions quant à l'organisation, ainsi que le détail des activités prévues dans chaque école.
Qui encadre votre enfant ? Il est pris en charge par une équipe composée :
 * d’un référent ALAé : c'est votre interlocuteur pour ce qui concerne tous les temps périscolaires
 * d’un adjoint au référent ALAé
 * de personnel encadrant : des ATSEM (Agents Territoriaux Spécialisés des Ecoles Maternelles) et des accompagnateurs

 * L'organisation de la semaine d'ALAE (PDF, 226 ko) 
 * Le règlement de fonctionnement des ALAE (PDF, 664 ko) 

### L'Accueil de Loisirs Associé à l'école (ALAé) 2024 - 2025 
Nouveauté : changement du portail famille, vous pouvez désormais réserver vos temps ALAé sur mesure !
OUVERTURE AU 26 AOUT !
Avant toute réservation le dossier Unique Enfant (DUE) doit être réalisé.
 * Accéder à la démarche en ligne

## Devenir animateur de temps périscolaires 
Consulter l'offre de vacation
## Accessibilité 
