# https://www.nimes.fr/mon-quotidien/services-et-mairies/#main-menu
 ...
 * Trouver une adresse, un contact
 ...
 1. Nîmes
 2. Mon quotidien
 3. Services et mairies

# Services et mairies 
Contacter la mairie, localiser un équipement de la ville, consulter les offres d'emploi… Retrouver toutes les informations et démarches liées. 
Accès rapides
## Contacter la mairie, les mairies de quartier et annexes 
Les points d'accueil municipaux, implantés dans différents lieux de la ville, vous permettent d'effectuer vos démarches administratives ou de formuler vos différentes demandes.
Consulter la rubrique
## Demande d'intervention sur l'espace public (IEP) 
Consulter la rubrique
## Cartographie des équipements 
Localisez en un clin d’œil les accueils municipaux, les aires de jeux et de loisirs, les écoles ou les équipements sportifs du territoire de Nîmes et de sa métropole sur une carte interactive.
Consulter la rubrique
## Objets trouvés 
Le service des Objets trouvés de la Ville de Nîmes récupère les objets abandonnés ou perdus sur l'espace public. Retrouver toutes les démarches liées.
Consulter la rubrique
## Cimetières et crématorium 
Retrouver toutes les démarches : les formalités à accomplir en cas de décès d'un proche, acheter une concession funéraire, être accompagné pour une cérémonie au crématorium...
Consulter la rubrique
## L'organigramme des services de la Ville de Nîmes 
Télécharger l'organigramme des services
Partager cette page
 1. 2. 
