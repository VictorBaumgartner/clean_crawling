# https://www.nimes.fr/mon-quotidien/vie-associative-et-de-quartiers/vie-associative/les-demarches-demander-une-subvention-proposer-un-evenement
 ...
 * Trouver une adresse, un contact
 ...
 4. Vie associative
 5. Les démarches : demander une subvention, proposer un événement

# Les démarches : demander une subvention, proposer un événement 
Accès rapides
 * Espace demande de subvention et maison des associations 

### Espace demande de subvention et maison des associations 
Toute demande de subvention ou avantage en nature s'effectue EXCLUSIVEMENT de façon dématérialisée.
Astuce : utiliser France Connect pour une création immédiate, rapide et sans effort !
Pour les demandes de subvention de fonctionnement et d’investissement 2026 , le portail sera ouvert du 1er juillet au 30 septembre 2025.
 * Accéder à la démarche en ligne

### Information accessibilité numérique 
Les documents disponibles en téléchargement sur le portail démarches de la Ville de Nîmes ne sont peut-être pas accessibles aux personnes utilisant un lecteur d'écran ou de toute autre technologie d'assistance. Pour remédier à ce besoin, afin de trouver une solution, nous vous proposons d'envoyer un courriel au service communication.
Partager cette page
 1. 2. 
