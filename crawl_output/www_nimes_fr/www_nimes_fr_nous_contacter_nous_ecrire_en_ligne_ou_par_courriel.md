# https://www.nimes.fr/nous-contacter/nous-ecrire-en-ligne-ou-par-courriel
 ...
 * Trouver une adresse, un contact
 ...
 1. Nîmes
 2. Nous contacter
 3. Nous écrire en ligne ou par courrier

# Nous écrire en ligne ou par courrier 
Vous avez une question ? Écrivez-nous via nos formulaires de contact ou par courrier. Pour un signalement sur la voie publique, pensez à l'application Nîmes.
Accès rapides
 * Foire aux questions 
 * Nous contacter via le formulaire de contact 
 * Signaler un incident 
 * Déposer un objet trouvé ou déclarer un objet perdu 
 * Nous écrire par courrier 

## Foire aux questions 
Avant de nous contacter, merci de consulter nos Foire aux questions (FAQ) pour voir si vous trouvez une réponse.
Accéder aux foires aux questions (FAQ)
## Nous contacter via le formulaire de contact 
À noter : nous ne diffusons pas d'adresses mail directes. Merci de sélectionner via le formulaire l'objet de votre demande afin d'envoyer au bon service.
Nous contacter
## Signaler un incident 
Vous pouvez également signaler un incident, un constat sur la voie publique :
 * incident sur la voirie (nids de poule, mobilier urbain…);
 * éclairage public (réverbère éteint…);
 * propreté - nettoiement (chaussée ou trottoir sale,…);
 * espaces verts, débroussaillement (sur la voirie);
 * dégradation sur la voie publique;
 * Autres.

## Demander une intervention sur l'espace public (IEP) 
...
Sur cette plateforme, vous pourrez signaler un problème sur la voie publique, les espaces verts, l'équipement urbain, la défense extérieure contre incendies…
Accéder à la démarche en ligne
### Déposer un objet trouvé ou déclarer un objet perdu 
Le service des objets trouvés de la Ville de Nîmes récupère les objets abandonnés ou perdus sur l'espace public.
Ces objets sont déposés par la Police Nationale (qui les achemine deux fois par an) ou municipale, les agents d’entretien ou par des particuliers. Renseignez-vous pour les déposer ou les récupérer.
Accéder à la démarche en ligne
## Nous écrire par courrier 
Maire de Nîmes Place de l'Hôtel de Ville 30033 Nîmes Cedex 9
Partager cette page
 1. 2. 
