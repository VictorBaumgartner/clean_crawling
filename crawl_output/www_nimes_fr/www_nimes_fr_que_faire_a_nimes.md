# https://www.nimes.fr/que-faire-a-nimes/#main-menu
...
# Que faire à Nîmes ? 
Bons plans et activités sont au rendez-vous à Nîmes ! Découvrez ce que nos services mettent à votre disposition pour embellir votre quotidien...
## Culture 
Musées, théâtres, salles de spectacle, bibliothèques, conservatoire : retrouver toutes les informations et démarches liées.
 * Bons plans culture
 * Les musées - le planétarium
 * Offre éducative
 * Les théâtres et salles de spectacle
 * Réseau de bibliothèques municipales
 * Le Conservatoire à Rayonnement Départemental : Musique - Danse - Théâtre
 * Agenda culturel

Consulter la rubrique
## Sport 
Localiser un équipement sportif de la Ville de Nîmes, s'inscrire aux ateliers sportifs, consulter les horaires des piscines nîmoises…
 * Bons plans sportifs
 * Les stades
 * La patinoire de Nîmes
 * Les piscines
 * Les gymnases
 * Autres équipements
...
Consulter la rubrique
## Nature 
Découvrir un parc de la ville de Nîmes, consulter et s'inscrire aux sortie nature : retrouver toutes les informations et démarches liées dans cette rubrique.
 * Activités et sorties nature
 * Découvrir les parcs, jardins et espaces naturels en Ville

Consulter la rubrique
## Événements 
Consulter les principaux événements proposés par la Ville de Nîmes.
 * Les événements incontournables
 * Sortir à Nîmes

Consulter la rubrique
## Commerces 
Retrouver tous les événements organisés en partenariat avec les commerces de la ville de Nîmes.
 * Les commerçants de Nîmes
 * Les jeudis de Nîmes
 * La fête de la truffe
 * La Grande braderie
 * Les marchés de Nîmes
 * Les Halles de Nîmes
